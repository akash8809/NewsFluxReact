...
export function HeadlineSlider({ headlines }: HeadlineSliderProps) {
  ...
  return (
    <div className="relative rounded-lg overflow-hidden mb-6 shadow-sm border border-gray-200 dark:border-gray-700 group">
      {/* Slide counter */}
      ...
      <div className="bg-gradient-to-r from-primary/5 to-transparent dark:from-gray-900/30 dark:to-transparent">
        <Link href={`/article/${encodeURIComponent(headline.title)}`}>
          <div className="flex flex-col md:flex-row items-stretch cursor-pointer group/article h-full">
            ...
            {headline.image && (
              <div className="md:w-2/5 relative overflow-hidden">
                ...
                <img 
                  src={headline.image} 
                  alt={headline.title}
                  className="w-full h-full object-cover min-h-[200px] group-hover/article:scale-105 transition-transform duration-500"
                />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 z-20 md:hidden">
                  ...
                  <h2 className="text-lg font-bold line-clamp-2 text-white">
                    {headline.title}
                  </h2>
                </div>
              </div>
            ...
            {/* Content container - desktop view */}
            <div className="hidden md:flex md:w-3/5 p-5 md:p-6 flex-col justify-center">
              ...
              <h2 className="text-lg md:text-xl font-bold line-clamp-2 group-hover/article:text-primary transition-colors">
                {headline.title}
              </h2>
              ...
              <div className="mt-4 text-primary text-xs font-medium flex items-center space-x-1.5 group-hover/article:translate-x-1 transition-transform duration-200">
            ...
            <div className="md:hidden p-4">
              ...
              <div className="mt-3 text-primary text-xs font-medium flex items-center space-x-1">
                <span>Read more</span>
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
